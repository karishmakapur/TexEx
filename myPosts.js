...
//to test with no results, comment out the below line and run it.
	results = [
		["10", "Images/samplePic.svg","Book Number 1", "1234567890", "Karishma Kapur", "This is a book by Karishma Kapur. If you would like to purchase it, please contact me at (111)111-1111. Thank you."],
...
function displayResults(results){
	...
	for(var i = results.length-1; i >= 0; i--){
		...
		document.getElementById("nav").insertAdjacentElement('afterend', searchResultContainer);
