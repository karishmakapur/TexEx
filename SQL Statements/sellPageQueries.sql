...
VALUES ((SELECT USERID FROM tbl_user WHERE Email LIKE 'kapur004@cougars.csusm.edu'),'Give Me Liberty! An American History', 'Eric Foner', '978-0393418262', 'This is an economics textbook. Contact me at (222)222-2222', 'Images/GiveMeLiberty.PNG', now(), NULL, TRUE);
